...
images_path = "..\\..\\Decompile\\20251002\\ExportedProject\\Assets\\Texture2D\\"
...
for item in json_data["emote"]:
    shutil.copy(images_path + json_data["emote"][item].get("icon"), destination_path + "emote\\" + json_data["emote"][item].get("icon"))
    shutil.copy(images_path + json_data["emote"][item].get("image"), destination_path + "emote\\" + json_data["emote"][item].get("image"))
